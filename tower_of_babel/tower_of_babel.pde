...
{
  size(600, 600);
  playerChassis = new SpriteObject("tank.png");
  playerChassis.x = 560;
  playerChassis.y = 300;
  playerTurret = new SpriteObject("turret.png");
  ...
  for(int c = 0; c < 15; c++)
  {
    enemyChassis[c] = new SpriteObject("tank.png");
    enemyChassis[c].x = 40;
    enemyChassis[c].y = 300;
    
    enemyTurrets[c] = new SpriteObject("turret.png");
    enemyTurrets[c].x = 40;
  ...
  for(int c = 0; c < 24; c++)
  {
    blockers[c] = new SpriteObject("building.png");
    blockers[c+24] = new SpriteObject("building.png");
    blockers[c+35] = new SpriteObject("building.png");
  ...
  for(int c = 0; c < 20; c++)
  {
    temp[c] = new SpriteObject("building.png");
  ...
  for(int c = 0; c < 15; c++)
  {
    bExplosions[c] = new AnimatedSpriteObject("explosion.png");
    bExplosions[c].x = -100;
    bExplosions[c].y = -100;
  ...
  for(int c = 0;c < 5; c++)
  {
    cExplosions[c] = new AnimatedSpriteObject("explosion.png");
    cExplosions[c].x = -100;
    cExplosions[c].y = -100;
    cExplosions[c].s = 0.5;
  ...
  redBase = new SpriteObject("building.png");
  redBase.x = 40;
  redBase.y = 300;
  redBase.s = 0.15;
  blueBase = new SpriteObject("building.png");
  blueBase.x = 560;
  blueBase.y = 300;
  blueBase.s = 0.15;
  for(int c = 0; c < 4; c++)
  {
    endExplode[c] = new AnimatedSpriteObject("explosion.png");
    endExplode[c].x = -100;
    endExplode[c].y = -100;
    endExplode[c].s = 3.5;
  ...
  for(int c = 0; c < 9; c++)
  {
    pellets[c] = new SpriteObject("bullet.png");
  }
  pellets[0].x = 154;
  pellets[0].y = 60;
  pellets[1].x = 154;
